      ...
      <div className={style.icons}>
        <div className={style.front}>
          ...
          <img
            ...
            style={{ marginLeft: "2rem" }}
          />
          <img src={ReactPng} height="140rem" alt="react" style={{ marginLeft: "2rem" }}/>
          <img
        ...
        <div className={style.back}>
          ...
          <img
            ...
            style={{ marginLeft: "2rem" }}
          />
          <img src={Node} height="140rem" alt="Node Js" style={{ marginLeft: "2rem" }} />
          <img src={Express} height="140rem" alt="Express" style={{ marginLeft: "2rem" }}/>
          <img src={Sequelize} height="140rem" alt="Sequelize" style={{ marginLeft: "2rem" }}/>
        </div>
